...
class PropertyForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['property_name', 'buyer', 'seller', 'dealer', 'state', 'city', 'address1', 'address2', 'nearby', 'total_amount', 'rate', 'advance_payment', 'expenses', 'registry_date', 'sai', 'size', 'size_unit'] # all the fields from the model class that I want in the form
        widgets = {
