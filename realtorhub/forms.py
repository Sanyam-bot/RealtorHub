...
class PropertyForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['property_name', 'buyer_1', 'buyer_2', 'buyer_3', 'buyer_4', 'buyer_5', 'seller', 'dealer_1', 'dealer_2', 'state', 'city', 'address1', 'nearby', 'total_amount', 'rate', 'expenses', 'registry_date', 'sai', 'size', 'size_unit'] # all the fields from the model class that I want in the form
        widgets = {
